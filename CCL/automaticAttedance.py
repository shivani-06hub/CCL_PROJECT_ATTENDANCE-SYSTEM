...
employeedetails_path = (
    "EmployeeDetails/EmployeeDetails.csv"
)
...
def subjectChoose(text_to_speech):
    def FillAttendance():
        ...
        if sub == "":
            ...
            try:
                ...
                df = pd.read_csv(employeedetails_path)
    ...
    titl = tk.Label(subject, bg="black", relief=RIDGE, bd=10, font=("arial", 30, "bold"))
    titl.pack(fill=X)
    titl = tk.Label(
        subject,
